...
for filepath in glob.glob("*.html"):
    if filepath == 'index.html' or filepath == 'fixtures.html': 
        continue # Already done or skip
    with open(filepath, 'r') as f:
        content = f.read()
    
    # Regex to find <!-- NAV --> down to </a> for the nav-brand
    pattern = r'<!-- NAV -->\s*<nav class="nav">\s*<a href="index\.html" class="nav-brand">.*?</a>'
